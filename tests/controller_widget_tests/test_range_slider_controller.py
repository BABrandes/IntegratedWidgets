...
from observables import ObservableSingleValue, HookProtocol
...
def test_range_slider_controller_initialization_with_default_values(qtbot: QtBot) -> None:
    ...
    controller = RangeSliderController(
        debounce_of_range_slider_changes_ms=100,
...
def test_range_slider_controller_default_parameters(qtbot: QtBot) -> None:
    ...
    controller = RangeSliderController(debounce_of_range_slider_changes_ms=100)
