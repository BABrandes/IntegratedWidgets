"""Tests for IQtDictSelection widget."""
...
def test_iqt_dict_selection_initialization_with_direct_value(qtbot: QtBot, sample_dict: dict[str, str]) -> None:
    """Test that IQtDictSelection initializes correctly with direct dictionary value."""
    widget = IQtDictSelection(
        sample_dict,
        selected_key="apple",
...
@pytest.mark.qt_log_ignore(".*")
def test_iqt_dict_selection_initialization_first_key_default(qtbot: QtBot, sample_dict: dict[str, str]) -> None:
    """Test that IQtDictSelection initializes with first key when no selection provided."""
    widget = IQtDictSelection(
        sample_dict,
        debounce_ms=TEST_DEBOUNCE_MS
    )
    ...
    assert widget.selected_key is not None
    assert widget.selected_key in sample_dict
    assert widget.selected_value == sample_dict[widget.selected_key]


@pytest.mark.qt_log_ignore(".*")
def test_iqt_dict_selection_initialization_with_observable(qtbot: QtBot, sample_dict: dict[str, str]) -> None:
    """Test that IQtDictSelection initializes correctly with observable."""
...
@pytest.mark.qt_log_ignore(".*")
def test_iqt_dict_selection_selected_key_setter(qtbot: QtBot, sample_dict: dict[str, str]) -> None:
...
@pytest.mark.qt_log_ignore(".*")
def test_iqt_dict_selection_dict_like_interface(qtbot: QtBot, sample_dict: dict[str, str]) -> None:
...
@pytest.mark.qt_log_ignore(".*")
def test_iqt_dict_selection_dict_modification(qtbot: QtBot, sample_dict: dict[str, str]) -> None:
...
@pytest.mark.qt_log_ignore(".*")
def test_iqt_dict_selection_delete_key(qtbot: QtBot, sample_dict: dict[str, str]) -> None:
...
@pytest.mark.qt_log_ignore(".*")
def test_iqt_dict_selection_change_dict_value(qtbot: QtBot, sample_dict: dict[str, str]) -> None:
...
@pytest.mark.qt_log_ignore(".*")
def test_iqt_dict_selection_formatter(qtbot: QtBot, sample_dict: dict[str, str]) -> None:
...
@pytest.mark.qt_log_ignore(".*")
def test_iqt_dict_selection_hooks(qtbot: QtBot, sample_dict: dict[str, str]) -> None:
...
@pytest.mark.qt_log_ignore(".*")
def test_iqt_dict_selection_copy(qtbot: QtBot, sample_dict: dict[str, str]) -> None:
...
@pytest.mark.qt_log_ignore(".*")
def test_iqt_dict_selection_integer_keys(qtbot: QtBot) -> None:
...
@pytest.mark.qt_log_ignore(".*")
def test_iqt_dict_selection_error_handling(qtbot: QtBot, sample_dict: dict[str, str]) -> None:
...
@pytest.mark.qt_log_ignore(".*")
def test_iqt_dict_selection_widget_creation(qtbot: QtBot, sample_dict: dict[str, str]) -> None:
    ...
    assert widget.controller.widget_combobox.count() == len(sample_dict)


@pytest.mark.qt_log_ignore(".*")
def test_iqt_dict_selection_empty_dict_raises_error(qtbot: QtBot) -> None:
    """Test that IQtDictSelection raises error with empty dictionary."""
