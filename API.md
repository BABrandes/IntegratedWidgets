...
class BaseSingleHookController(BaseController):
    def __init__(
        self,
        hook_source: OwnedHookProtocol[PHK, SHK, PHV, SHV, C],
...
class IntegerEntryController(BaseSingleHookController):
    def __init__(
        self,
        value: OwnedHookProtocol[PHK, SHK, PHV, SHV, C],
        *,
        label_text: str = "",
...
class RadioButtonsController(BaseComplexHookController):
    def __init__(
        self,
        value: OwnedHookProtocol[PHK, SHK, PHV, SHV, C],
        options: OwnedHookProtocol[PHK, SHK, PHV, SHV, C],
        *,
        label_text: str = "",
        nexus_manager: NexusManager = DEFAULT_NEXUS_MANAGER,
        debounce_ms: int = DEFAULT_DEBOUNCE_MS,
...
class RangeSliderController(BaseComplexHookController):
    def __init__(
        self,
        range_min: OwnedHookProtocol[PHK, SHK, PHV, SHV, C],
        range_max: OwnedHookProtocol[PHK, SHK, PHV, SHV, C],
        *,
        absolute_min: float,
        absolute_max: float,
        label_text: str = "",
...
class RealUnitedScalarController(BaseComplexHookController):
    def __init__(
        self,
        value: OwnedHookProtocol[PHK, SHK, PHV, SHV, C],
        unit: OwnedHookProtocol[PHK, SHK, PHV, SHV, C],
        dimension: str,
        *,
        label_text: str = "",
        nexus_manager: NexusManager = DEFAULT_NEXUS_MANAGER,
