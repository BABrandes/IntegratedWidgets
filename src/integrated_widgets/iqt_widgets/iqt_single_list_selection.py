...
class IQtSingleListSelection(IQtControlledLayoutedWidget[Literal["selected_option", "available_options"], Optional[T] | frozenset[T], Controller_Payload, SingleListSelectionController[T]], Generic[T]):
    """
