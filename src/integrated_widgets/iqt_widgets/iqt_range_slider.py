...
from integrated_widgets.util.base_single_hook_controller import HookWithOwnerProtocol
...
class IQtRangeSlider(IQtControlledLayoutedWidget[
    ...
    def __init__(
        self,
        number_of_ticks: int | ObservableSingleValueProtocol[int] | HookProtocol[int] = 100,
        span_lower_relative_value: float | ObservableSingleValueProtocol[float] | HookProtocol[float] = 0.0,
        span_upper_relative_value: float | ObservableSingleValueProtocol[float] | HookProtocol[float] = 1.0,
        minimum_span_size_relative_value: float | ObservableSingleValueProtocol[float] | HookProtocol[float] = 0.0,
        range_lower_value: T | ObservableSingleValueProtocol[T] | HookProtocol[T] = math.nan,
        range_upper_value: T | ObservableSingleValueProtocol[T] | HookProtocol[T] = math.nan,
        *,
        ...
        Parameters
        ----------
        number_of_ticks : int | ObservableSingleValueProtocol[int] | HookProtocol[int], optional
            Number of discrete tick positions. Default is 100.
        span_lower_relative_value : float | ObservableSingleValueProtocol[float] | HookProtocol[float], optional
            Lower span position (0.0 to 1.0). Default is 0.0.
        span_upper_relative_value : float | ObservableSingleValueProtocol[float] | HookProtocol[float], optional
            Upper span position (0.0 to 1.0). Default is 1.0.
        minimum_span_size_relative_value : float | ObservableSingleValueProtocol[float] | HookProtocol[float], optional
            Minimum span size (0.0 to 1.0). Default is 0.0 (no minimum).
        range_lower_value : float | RealUnitedScalar | ObservableSingleValueProtocol[...] | HookProtocol[...], optional
            Range minimum value. Default is math.nan.
        range_upper_value : float | RealUnitedScalar | ObservableSingleValueProtocol[...] | HookProtocol[...], optional
    ...
    @property
    def number_of_ticks_hook(self) -> HookWithOwnerProtocol[int]:
        """
    ...
    @property
    def span_lower_relative_value_hook(self) -> HookWithOwnerProtocol[float]:
        """
    ...
    @property
    def span_upper_relative_value_hook(self) -> HookWithOwnerProtocol[float]:
        """
        Relative value of the lower bound of the selected span (0.0 to 1.0).
    ...
    @property
    def minimum_span_size_relative_value_hook(self) -> HookWithOwnerProtocol[float]:
        """
    ...
    @property
    def range_lower_value_hook(self) -> HookWithOwnerProtocol[T]:
        """
    ...
    @property
    def range_upper_value_hook(self) -> HookWithOwnerProtocol[T]:
        """
    ...
    @property
    def span_lower_value_hook(self) -> HookWithOwnerProtocol[T]:
        """
    ...
    @property
    def span_upper_value_hook(self) -> HookWithOwnerProtocol[T]:
        """
    ...
    @property
    def span_size_value_hook(self) -> HookWithOwnerProtocol[T]:
        """
    ...
    @property
    def span_center_value_hook(self) -> HookWithOwnerProtocol[T]:
        """
