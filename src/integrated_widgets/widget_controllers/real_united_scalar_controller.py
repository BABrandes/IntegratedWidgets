...
from observables import ObservableSingleValueProtocol, ObservableDictProtocol, HookProtocol
...
class RealUnitedScalarController(BaseComplexHookController[Literal["scalar_value", "unit_options", "unit", "float_value"], Literal["dimension", "selectable_units"], RealUnitedScalar|dict[Dimension, set[Unit]]|Unit|float, Dimension|set[Unit], "RealUnitedScalarController"]):
    ...
    **Voltage measurements:**
    ...
    def __init__(
        self,
        value_or_hook_or_observable: RealUnitedScalar | HookProtocol[RealUnitedScalar] | ObservableSingleValueProtocol[RealUnitedScalar] = RealUnitedScalar.nan(Dimension.dimensionless_dimension()),
        ...
        *,
        ...
        Args:
            value_or_hook_or_observable: The initial physical quantity to display. Can be:
                ...
                - A HookProtocol that provides RealUnitedScalar values
            ...
            display_unit_options: Available units for the dropdown selector. Can be:
                ...
                - A HookProtocol providing the dictionary
        ...
        if isinstance(value_or_hook_or_observable, RealUnitedScalar):
            ...
            scalar_value_provided_hook: Optional[HookProtocol[RealUnitedScalar]] = None

        elif isinstance(value_or_hook_or_observable, HookProtocol):
            # It's a hook
        ...
        if display_unit_options is None:
            ...
            unit_options_provided_hook: Optional[HookProtocol[dict[Dimension, set[Unit]]]] = None
        ...
        elif isinstance(display_unit_options, HookProtocol):
            # It's a hook
    ...
    def value_hook(self) -> HookWithOwnerProtocol[RealUnitedScalar]:
        ...
        Returns:
            HookProtocol[RealUnitedScalar]: Hook providing access to scalar_value
    ...
    @property
    def float_value_hook(self) -> HookWithOwnerProtocol[float]:
    ...
    @property
    def dimension_hook(self) -> HookWithOwnerProtocol[Dimension]:
    ...
    @property
    def selectable_units_hook(self) -> HookWithOwnerProtocol[set[Unit]]:
