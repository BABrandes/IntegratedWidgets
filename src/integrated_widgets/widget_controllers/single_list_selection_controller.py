...
from observables import ObservableOptionalSelectionOptionProtocol, ObservableSetProtocol, ObservableSingleValueProtocol, HookProtocol
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(selected_option, ObservableOptionalSelectionOptionProtocol):
            ...
            selected_option_hook: Optional[HookProtocol[Optional[T]]] = selected_option.selected_option_hook # type: ignore
            available_options_initial_value: set[T] = selected_option.available_options # type: ignore
            available_options_hook: Optional[HookProtocol[set[T]]] = selected_option.available_options_hook # type: ignore
        else:
            ...
            if isinstance(selected_option, ObservableSingleValueProtocol):
                ...
                selected_option_initial_value: Optional[T] = selected_option.value # type: ignore
                selected_option_hook: Optional[HookProtocol[Optional[T]]] = selected_option # type: ignore
            else:
