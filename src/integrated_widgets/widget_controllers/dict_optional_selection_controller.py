...
class DictOptionalSelectionController(BaseComplexHookController[Literal["dict", "selected_key", "selected_value"], Any, Any, Any, "DictOptionalSelectionController"], Generic[K,V]):
    ...
    Parameters
    ----------
    dict_value : dict[K, V] | HookProtocol[dict[K, V]] | ObservableOptionalSelectionDict[K, V]
    ...
    selected_key : Optional[K] | HookProtocol[Optional[K]] | None
    ...
    selected_value : Optional[V] | HookProtocol[Optional[V]] | None
    ...
    dict_hook : OwnedHookProtocol[dict[K, V]]
        Hook for the dictionary that can be connected to observables.
    selected_key_hook : OwnedHookProtocol[Optional[K]]
        Hook for the selected key that can be connected to observables.
    selected_value_hook : OwnedHookProtocol[Optional[V]]
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(dict_value, ObservableOptionalSelectionDict):
            ...
            hook_dict_value: Optional[HookProtocol[dict[K, V]]] = dict_value.dict_hook # type: ignore
            initial_selected_key: Optional[K] = dict_value.key_hook.value # type: ignore
            hook_selected_key: Optional[HookProtocol[Optional[K]]] = dict_value.key_hook # type: ignore
            initial_selected_value: Optional[V] = dict_value.value_hook.value # type: ignore
            hook_selected_value: Optional[HookProtocol[Optional[V]]] = dict_value.value_hook # type: ignore
            ...
            if isinstance(dict_value, Hook):
                ...
                log_msg(self, "__init__", logger, "dict_value is HookProtocol")
                initial_dict_value: dict[K, V] = dict_value.value # type: ignore
                hook_dict_value: Optional[Hook[dict[K, V]]] = dict_value # type: ignore
                log_msg(self, "__init__", logger, f"From HookProtocol: initial_dict_value={initial_dict_value}")
            ...
            if selected_key is None:
                ...
                # It's a hook - get initial value
                log_msg(self, "__init__", logger, "selected_key is HookProtocol")
                ...
                log_msg(self, "__init__", logger, f"From HookProtocol: initial_selected_key={initial_selected_key}")
            ...
            if selected_value is None:
                ...
                # It's a hook - get initial value
                log_msg(self, "__init__", logger, "selected_value is HookProtocol")
                ...
                log_msg(self, "__init__", logger, f"From HookProtocol: initial_selected_value={initial_selected_value}")
