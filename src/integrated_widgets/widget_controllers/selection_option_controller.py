...
class SelectionOptionController(BaseWidgetControllerWithDisable[Literal["selected_option", "available_options"], Any, Any, Any], ObservableSelectionOptionLike[T], Generic[T]):
