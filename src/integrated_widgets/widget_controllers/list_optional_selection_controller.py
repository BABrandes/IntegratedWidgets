...
# BAB imports
from observables import ObservableSingleValueProtocol, ObservableSetProtocol, ObservableOptionalSelectionOptionProtocol, HookProtocol
...
class ListOptionalSelectionController(BaseComplexHookController[Literal["selected_option", "available_options"], Any, Any, Any, "ListOptionalSelectionController"], ObservableOptionalSelectionOptionProtocol[T], Generic[T]):
    ...
    selected_option_hook : OwnedHookProtocol[Optional[T]]
        ...
        *,
        ...
        if isinstance(selected_option, ObservableOptionalSelectionOptionProtocol):
            ...
            if selected_option is None:
                ...
                hook_selected_option: Optional[HookProtocol[Optional[T]]] = selected_option # type: ignore
                ...
                hook_selected_option: Optional[HookProtocol[Optional[T]]] = selected_option.hook # type: ignore
    ...
    def selected_option_hook(self) -> HookWithOwnerProtocol[Optional[T]]:
        ...
        Returns
        -------
        OwnedHookProtocol[Optional[T]]
            The hook object for the selected_option value.
        """
        hook: HookWithOwnerProtocol[Optional[T]] = self.get_hook("selected_option") # type: ignore
        return hook
