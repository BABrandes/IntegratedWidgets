...
class SelectionOptionalOptionController(BaseObservableController[Literal["selected_option", "available_options"], Any], ObservableOptionalSelectionOptionLike[T], Generic[T]):
