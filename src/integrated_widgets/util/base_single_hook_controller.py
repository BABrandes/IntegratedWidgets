...
from observables import ObservableSingleValueProtocol, HookProtocol
from observables.core import HookNexus, CarriesHooksBase, NexusManager, DEFAULT_NEXUS_MANAGER, HookWithOwnerProtocol, OwnedHook
...
class BaseSingleHookController(BaseController[Literal["value"], T, C], CarriesHooksBase[Literal["value"], T, C], Generic[T, C]):
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(value_or_hook_or_observable, ObservableSingleValueProtocol):
            ...
            value_provided_hook: Optional[HookProtocol[T]] = value_or_hook_or_observable.hook # type: ignore
        ...
        if isinstance(value_provided_hook, HookProtocol):
    ...
    @property
    def value_hook(self) -> HookWithOwnerProtocol[T]:
    ...
    def _get_hook(self, key: Literal["value"]) -> HookWithOwnerProtocol[T]:
        """
    ...
    def _get_hook_key(self, hook_or_nexus: HookWithOwnerProtocol[Any]|HookNexus[Any]) -> Literal["value"]:
        """
